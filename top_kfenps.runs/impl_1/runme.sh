...
HD_PWD='G:/VC707/top_kfenps/top_kfenps.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_kfenps.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_kfenps.tcl -notrace
