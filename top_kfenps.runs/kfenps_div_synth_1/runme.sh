...
HD_PWD='G:/VC707/top_kfenps/top_kfenps/top_kfenps.runs/kfenps_div_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kfenps_div.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kfenps_div.tcl
