...
HD_PWD='G:/VC707/top_kfenps/top_kfenps.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_kfenps.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_kfenps.tcl
